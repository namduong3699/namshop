			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="wrap-slick3-dots">
								<ul class="slick3-dots" role="tablist" style="" id="dots-add">
									<!-- <li class="slick-active" role="presentation" data-slick-index='0'>
										<img src=" http://namshop.vn/images/product-detail-01.jpg ">
										<div class="slick3-dot-overlay">
										</div>
									</li>
									<li role="presentation" data-slick-index='1'>
										<img src=" http://namshop.vn/images/product-detail-02.jpg ">
										<div class="slick3-dot-overlay">
										</div>
									</li>
									<li role="presentation" data-slick-index='2'>
										<img src=" http://namshop.vn/images/product-detail-03.jpg ">
										<div class="slick3-dot-overlay">
										</div>
									</li> -->
								</ul>
							...
							<div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
								<div class="slick-list draggable">
									<div class="slick-track " style="opacity: 1; width: 1539px;" id='slick-add'>
										...
										<div class="item-slick3 slick-slide" data-thumb="http://namshop.vn/images/product-detail-02.jpg" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide21" aria-describedby="slick-slide-control21" style="width: 513px; position: relative; left: -513px; top: 0px; ">
											<div class="wrap-pic-w pos-relative">
												<img src="http://namshop.vn/images/product-detail-02.jpg" alt="IMG-PRODUCT">
												<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/product-detail-02.jpg" tabindex="-1">
													<i class="fa fa-expand"></i>
												</a>
											</div>
										</div>
										<div class="item-slick3 slick-slide" data-thumb="http://namshop.vn/images/product-detail-03.jpg" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide22" aria-describedby="slick-slide-control22" style="width: 513px; position: relative; left: -1026px; top: 0px; ">
											<div class="wrap-pic-w pos-relative">
												<img src="http://namshop.vn/images/product-detail-03.jpg" alt="IMG-PRODUCT">

												<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="http://namshop.vn/images/product-detail-03.jpg" tabindex="-1">
													<i class="fa fa-expand"></i>
												</a>
											</div>
										</div> -->
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-detail p-b-14" id="nameItems">
						</h4>
						...
						<p class="stext-102 cl3 p-t-23" id="infor">
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2 select2-hidden-accessible" name="time" tabindex="-1" aria-hidden="true" id="select-size">
										</select>
