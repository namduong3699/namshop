...
<header class="header-v3">
	...
	<div class="container-menu-desktop">
		...
		<div class="wrap-menu-desktop">
			...
			<div class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-wishlist wishlist-icon" data-notify="{{count(Cart::instance('wishlist')->content())}}">
...
<div class="wrap-header-mobile">
	...
	<div class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-wishlist wishlist-icon" data-notify="{{count(Cart::instance('wishlist')->content())}}">
		<i class="zmdi zmdi-favorite-outline" style="color: black"></i>
	</div>
</div>
